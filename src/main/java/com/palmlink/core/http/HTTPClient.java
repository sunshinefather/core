...
public class HTTPClient {
    ...
    public static final TimeLength DEFAULT_TIME_OUT = TimeLength.minutes(3);
    ...
    HttpResponse executeMethod(HTTPRequest request) throws IOException {
        HttpRequestBase httpRequest = request.create();
    ...
    private void configureBasicAuth() {
        if (basicAuthUser != null) {
            httpClient.getCredentialsProvider().setCredentials(AuthScope.ANY, new UsernamePasswordCredentials(basicAuthUser, basicAuthPassword));
        }
    }
