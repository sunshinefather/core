...
import com.palmlink.core.platform.web.site.cdn.CDNSettings;
import com.palmlink.core.platform.web.site.security.AuthSettings;
...
public abstract class TagSupport extends RequestContextAwareTag {
    ...
    public Integer[] compress(String fullSize, Integer width, Integer height) throws IOException {
        if (StringUtils.isBlank(fullSize))
