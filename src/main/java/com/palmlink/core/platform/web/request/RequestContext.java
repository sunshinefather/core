...
import com.palmlink.core.platform.web.DeploymentEnvironment;
import com.palmlink.core.platform.web.DeploymentSettings;
import com.palmlink.core.platform.web.filter.RequestUtils;
...
public class RequestContext {
    ...
    private final ReadOnly<String> action = new ReadOnly<String>(); // the
                                                                    // action
                                                                    // method,
    ...
    public String getServerName() {
        return DeploymentEnvironment.DEV.equals(deploymentSettings.getEnvironment()) ? request.value().getServerName() : StringUtils.isBlank(deploymentSettings.getHost()) ? request.value().getHeader("Host") : deploymentSettings.getHost();
    }
